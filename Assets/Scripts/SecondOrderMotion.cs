...
public class SecondOrderMotion : MonoBehaviour
{
    ...
    private LegsController _legsControler;
    // Start is called before the first frame update
    void Start()
    {
        _legsControler = GetComponentInParent<LegsController>();
        ...
        _dymamics[1] = new SecondOrderDynamics(_f, _z, _r, _legsControler.GetAverageHeight());
    ...
    void Update()
    {
        ...
        float y = _dymamics[1].Update(Time.deltaTime, _legsControler.GetAverageHeight());
